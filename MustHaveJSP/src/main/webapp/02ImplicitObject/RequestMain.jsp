...
<br />
<form action = "RequestWebInfo.jsp" method="post"> <!-- POST 방식으로 요청. "get" 하면 전송되는 파라메터가 주소 뒤에 다 붙어버린다. 보안이 안돼. -->
...
관심사항 :
<input type = "checkbox" name="favo" value="eco" />경제<!-- 이 값들이 배열로 들어간다 -->
